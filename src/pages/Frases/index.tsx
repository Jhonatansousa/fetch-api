...
export function Frases() {
  ...
  return (
    <div className="flex flex-col gap-5">
      <h1 className="text-3xl font-medium">Random Phrases</h1>
      <p>Clique no botão baixo para gerar uma frase aleatória em inglês</p>
      <button
      ...
      <h4 className="w-11/12 italic">{`"${frase}"`}</h4>
      <p className="text-highlight-color font-bold">{`- ${autor}`}</p>
    </div>
  )
}
